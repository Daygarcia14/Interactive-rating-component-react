...
function Card() {
    ...
    function handleOnclick(valor) {
        setNumber(valor);
    }

    function showSelection(valor) {
        if(number!==""){
            setSubmit(valor);
        }
    }
            ...
            <div className="content">
                <div className="card2">
                    ...
                    <div className="selection">
                        ...
                        <h1>Thank you!</h1>
                        <p>We appreciated you taking the time to give a rating. If you ever need more support, don't hesitate to get in touch!</p>
                </div>
            </div> :
            <div className="content">
                <div className="card">
                    ...
                    <div className="botones">
                        <button type="button" className="boton" onClick={() => handleOnclick("1")} style={{ backgroundColor: number === "1" ? "hsl(216, 12%, 54%)" : "", color: number === "1" ? "hsl(0, 0%, 100%)" : "hsl(217, 12%, 63%)" }}>
                            <span>1</span>
                        </button>
                        <button type="button" className="boton" onClick={() => handleOnclick("2")} style={{ backgroundColor: number === "2" ? "hsl(216, 12%, 54%)" : "", color: number === "2" ? "hsl(0, 0%, 100%)" : "hsl(217, 12%, 63%)" }}>
                            <span>2</span>
                        </button>
                        <button type="button" className="boton" onClick={() => handleOnclick("3")} style={{ backgroundColor: number === "3" ? "hsl(216, 12%, 54%)" : "", color: number === "3" ? "hsl(0, 0%, 100%)" : "hsl(217, 12%, 63%)" }}>
                            <span>3</span>
                        </button>
                        <button type="button" className="boton" onClick={() => handleOnclick("4")} style={{ backgroundColor: number === "4" ? "hsl(216, 12%, 54%)" : "", color: number === "4" ? "hsl(0, 0%, 100%)" : "hsl(217, 12%, 63%)" }}>
                            <span>4</span>
                        </button>
                        <button type="button" className="boton" onClick={() => handleOnclick("5")} style={{ backgroundColor: number === "5" ? "hsl(216, 12%, 54%)" : "", color: number === "5" ? "hsl(0, 0%, 100%)" : "hsl(217, 12%, 63%)" }}>
                            <span>5</span>
                        </button>
                    </div>
                    <div className="submit">
                        <button type="button" className="btn" onClick={() => showSelection("submit")}>SUBMIT</button>
                    </div>
                </div>
            </div>}
